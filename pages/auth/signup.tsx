...
export default function SignUp() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      await signIn('google', { callbackUrl: callbackUrl || '/panel' });
    } catch (error) {
